...
export class Client {
    ...
    protected processDashboard(response: AxiosResponse): Promise<DashboardDataDto> {
        ...
        if (status === 200) {
            ...
            result200 = DashboardDataDto.fromJS(resultData200, _mappings);
...
export class BarChartDataDto implements IBarChartDataDto {
    ...
    static fromJS(data: any, _mappings?: any): BarChartDataDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<BarChartDataDto>(data, _mappings, BarChartDataDto);
    }
...
export class BillingAddress implements IBillingAddress {
    ...
    static fromJS(data: any, _mappings?: any): BillingAddress | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<BillingAddress>(data, _mappings, BillingAddress);
    }
...
export class BillingAddressDto implements IBillingAddressDto {
    ...
    static fromJS(data: any, _mappings?: any): BillingAddressDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<BillingAddressDto>(data, _mappings, BillingAddressDto);
    }
...
export class Card implements ICard {
    ...
    static fromJS(data: any, _mappings?: any): Card | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<Card>(data, _mappings, Card);
    }
...
export class CustomerDto implements ICustomerDto {
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            ...
            this.billingAddress = _data["billingAddress"] ? BillingAddressDto.fromJS(_data["billingAddress"], _mappings) : <any>undefined;
        }
    }
        ...
        if (_data) {
            if (Array.isArray(_data["barChartData"])) {
                ...
                for (let item of _data["barChartData"])
                    this.barChartData!.push(BarChartDataDto.fromJS(item, _mappings));
            }
            if (Array.isArray(_data["pieChartData"])) {
                this.pieChartData = [] as any;
                for (let item of _data["pieChartData"])
                    this.pieChartData!.push(PieChartDataDto.fromJS(item, _mappings));
            }
            if (Array.isArray(_data["lineChartDotsData"])) {
                this.lineChartDotsData = [] as any;
                for (let item of _data["lineChartDotsData"])
                    this.lineChartDotsData!.push(LineChartDataDto.fromJS(item, _mappings));
            }
            if (Array.isArray(_data["lineChartData"])) {
                this.lineChartData = [] as any;
                for (let item of _data["lineChartData"])
                    this.lineChartData!.push(LineChartDataDto.fromJS(item, _mappings));
            }
            this.overviewData = _data["overviewData"] ? OverviewDataDto.fromJS(_data["overviewData"], _mappings) : <any>undefined;
        }
    }

    static fromJS(data: any, _mappings?: any): DashboardDataDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<DashboardDataDto>(data, _mappings, DashboardDataDto);
    }
...
export class LineChartDataDto implements ILineChartDataDto {
    ...
    static fromJS(data: any, _mappings?: any): LineChartDataDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<LineChartDataDto>(data, _mappings, LineChartDataDto);
    }
...
export class OverviewDataDto implements IOverviewDataDto {
    ...
    static fromJS(data: any, _mappings?: any): OverviewDataDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<OverviewDataDto>(data, _mappings, OverviewDataDto);
    }
...
export class PaymentBankSlipRequestDto implements IPaymentBankSlipRequestDto {
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            ...
            this.customer = _data["customer"] ? CustomerDto.fromJS(_data["customer"], _mappings) : <any>undefined;
        }
    }

    static fromJS(data: any, _mappings?: any): PaymentBankSlipRequestDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<PaymentBankSlipRequestDto>(data, _mappings, PaymentBankSlipRequestDto);
    }
...
export class PaymentCreditCardRequestDto implements IPaymentCreditCardRequestDto {
    ...
    static fromJS(data: any, _mappings?: any): PaymentCreditCardRequestDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<PaymentCreditCardRequestDto>(data, _mappings, PaymentCreditCardRequestDto);
    }
...
export class PaymentPixRequestDto implements IPaymentPixRequestDto {
    ...
    static fromJS(data: any, _mappings?: any): PaymentPixRequestDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<PaymentPixRequestDto>(data, _mappings, PaymentPixRequestDto);
    }
...
export class PieChartDataDto implements IPieChartDataDto {
    ...
    static fromJS(data: any, _mappings?: any): PieChartDataDto | null {
        data = typeof data === 'object' ? data : {};
        return createInstance<PieChartDataDto>(data, _mappings, PieChartDataDto);
    }
